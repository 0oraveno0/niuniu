class GameUI extends eui.Component {
    ...
    private card_sprite_arr = ["diamond","club","heart","spade"]
        ...
        Timer.addEventListener(
            egret.TimerEvent.TIMER_COMPLETE,() => {
                ...
                if(num == 999){
                    ...
                    c_to.source = this.card_sprite_arr[sprite_num % 4] + "_" + [Math.floor((sprite_num - 1) / 4) + 1] + "_png";
                }else{
                    ...
                    if(_j == 4){
                        ...
                        if(this.data["points"][player_id].prize_id == "niuniu"){
                            c_prize.text.text = ""
                ...
                if(count_last < 20){
                    ...
                    for(let i = 0; i < 3; i++){
                        if(result_money[i] != null){
                            if(result_money[i] >= 0){
                                ...
                                this.card_gp["card"][String(i + 1)]["prize"]["win"].textColor = 3845
                            }
                        }else{
                    ...
                    this.audio.play_sound("BtnClick_wav")
                    this.btn_gp["balance"].text = "$ " + this.data["balance"];
                    this.disable_btn(true);
